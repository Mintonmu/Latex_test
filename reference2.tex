...
\hangafter 1 \hangindent 1cm \noindent{Agrawal,  S. \quad(2019)  \quad\emph{MEANvs. LAMP: How To Choose the Right Tech Stack - Java Code Geeks - 2022.}\quad{\url{https://www.javacodegeeks.com/2019/09/mean-lamp-choose-the-right-tech-stack.html}}}\\

\hangafter 1 \hangindent 1cm \noindent{Agaarwal,  R.  \quad(2021)  \quad\emph{Mean Stack: Does it Have a Future?}\quad{\url{https://www.algoworks.com/blog/mean-stack-and-its-future/}}}\\
...
\hangafter 1 \hangindent 1cm \noindent{Augenstein, M.  \& Tenenbaum, A.  \quad(1977) \quad \emph{Program efficiency and data structures. Proceedings Of The Eighth SIGCSE Technical Symposium On Computer Science Education - SIGCSE '77.}\quad{\url{https://doi.org/10.1145/800106.803426}}}\\

\hangafter 1 \hangindent 1cm \noindent{Craigen, D. (2014). Defining Cybersecurity. TIM Review.  Retrieved from \quad {\url{https://www.timreview.ca/article/835}}}\\

\hangafter 1 \hangindent 1cm \noindent{Das,  A.  \quad(2021)  \quad\emph{Data Visualization in Data Science}\quad{\url{https://towardsdatascience.com/data-visualization-in-data-science-5681cbdde5bf}}}\\

\hangafter 1 \hangindent 1cm \noindent{Express.  \quad(n.d.) \quad \emph{Node.js web application framework.}\quad{\url{https://expressjs.com/}}}\\

\hangafter 1 \hangindent 1cm \noindent{Gregersen,  E \quad(2022)  \quad\emph{Apache - Web server}\quad{\url{hhttps://www.britannica.com/technology/Apache-Web-server}}}\\
...
\hangafter 1 \hangindent 1cm \noindent{Krakoff, S. (2019). Top Cybersecurity Skills in High Demand. Champlain College.  \quad{\url{https://online.champlain.edu/blog/top-cybersecurity-skills-in-high-demand}}}\\

\hangafter 1 \hangindent 1cm \noindent{Lowe,  D. \quad(2008)  \quad\emph{Networking All-in-One Desk Reference For Dummies}[eBook version]. \quad{\url{https://www.google.com.au/books/edition/Networking_All_in_One_Desk_Reference_For/XeKLe6B70-0C?hl=en&gbpv=1&dq=Why+Linux+treats+everything+as+a+file\%3F&pg=PA689&printsec=frontcover}}}\\

\hangafter 1 \hangindent 1cm \noindent{MERN Stack - Javatpoint. (2020). Www.Javatpoint.Com. \quad{\url{https://www.javatpoint.com/mern-stack}\\

\hangafter 1 \hangindent 1cm \noindent{MongoDB. (2019). What Is The MERN Stack? Introduction \& Examples. \quad{\url{https://www.mongodb.com/mern-stack}}}\\

\hangafter 1 \hangindent 1cm \noindent{P. Lourodas,  \quad(2022)  \quad\emph{Component Stacks for Enterprise Application} [in IEEE Software] \quad{\url{https://ieeexplore-ieee-org.ezproxy.library.sydney.edu.au/document/7420497}}}\\

\hangafter 1 \hangindent 1cm \noindent{Red Hat Company\quad (2019)  \quad\emph{What is Linux?}\quad{\url{https://www.redhat.com/en/topics/linux/what-is-linux\#:~:text=Linux\%C2\%AE\%20i\%20an\%20open,resources\%20that\%20do\%20the\%20work}}}\\

\hangafter 1 \hangindent 1cm \noindent{Red Hat Company. (2019). \emph{What is an IDE?} (see \url{https://www.redhat.com/en/topics/middleware/what-is-ide})

\hangafter 1 \hangindent 1cm \noindent{Simic,  S.  \quad(2022)  \quad\emph{What is LAMP Stack?}\quad{\url{https://phoenixnap.com/kb/what-is-a-lamp-stack}}}\\

\hangafter 1 \hangindent 1cm \noindent{Simplilearn Company \quad(2022)  \quad\emph{Understanding The Difference Between SQL And MySQL}\quad{\url{https://www.simplilearn.com/tutorials/sql-tutorial/difference-between-sql-and-mysql\#:~:text=SQL\%20is\%20a\%20query\%20programming,data\%20in\%20an\%20organized\%20wayr}}}\\

\hangafter 1 \hangindent 1cm \noindent{Stackshare.  \quad(n.d.)  \quad\emph{Why developers like MEAN. (2022)}\quad{\url{https://stackshare.io/mean}}}\\

\hangafter 1 \hangindent 1cm \noindent{Walch,  K. \quad (2021)  \quad\emph{14 most in-demand data science skills you need to succeed}\quad{\url{https://www.techtarget.com/searchbusinessanalytics/feature/The-most-in-demand-data-science-skills-you-need}}}\\

\hangafter 1 \hangindent 1cm \noindent{Wolff,  R.  \quad(2021)  \quad\emph{Data Preparation: Basics \& Techniques}\quad{\url{https://monkeylearn.com/blog/data-preparation/}}}\\

\hangafter 1 \hangindent 1cm \noindent{ \emph{What is PHP Used For? - Uses \& Advantages. }\quad(2018, October 25)\quad{\url{https://study.com/academy/lesson/what-is-php-used-for-uses-advantages.html}}}\\

\hangafter 1 \hangindent 1cm \noindent{Shea, S., Gillis, A. S., Clark, C. (2021). What is cybersecurity?.SearchSecurity. \quad{\url{https://www.techtarget.com/searchsecurity/definition/cybersecurity}}}\\

\hangafter 1 \hangindent 1cm \noindent{Yang,  R.  \& Crawford,R.  \quad(2018) [eResources,  The University of Sydney Library]  \quad\emph{Component Stacks for Enterprise Applications.}\quad{\url{Dl-acm-org.ezproxy.library.sydney.edu.au.  https://ieeexplore-ieee-org.ezproxy.library.sydney.edu.au/document/7420497}}}\\
